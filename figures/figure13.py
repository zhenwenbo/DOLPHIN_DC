...
throughput_data = {
    ...
    "w/o Feature Window Scheduling": [3.97,12.87,62.74,154.49,148.82],
    "DOLPHIN": [3.42,8.46,29.54,110.85,19.91],
}
throughput_df = pd.DataFrame(throughput_data)

io_time_data_dict = {
    "Datasets": ["LFM","WT","SO","BC","GDELT"],
    "w/o Feature Window Scheduling": [3.93,13.70,66.27,155.41,151.75],
    "DOLPHIN": [3.44,9.51,32.83,111.69,23.08],
    
}
io_time_df = pd.DataFrame(io_time_data_dict)

methods = ["w/o Feature Window Scheduling", "DOLPHIN"]
...
for i, method in enumerate(methods):
    offset = x - 0.5 * bar_width + i * bar_width  
...
ax_left.set_ylabel("Memory Usage(GB)", fontweight='bold', fontsize=26)



ax_left.set_xticks(x)
ax_left.set_xticklabels(datasets, fontsize=14,fontweight='bold')
ax_left.tick_params(
    axis='both',         
    labelsize=25,     
    width=2,           
...
ax_right.set_xticklabels(datasets, fontsize=14,fontweight='bold')
