...
throughput_data = {
    ...
    "w/o DISK-RAM-GPU Pipeline": [309.92,2004.92,6075.81,7701.92],
    "DOLPHIN": [63,482.69,1079.82,1489.2],
}
...
io_time_data_dict = {
    "Datasets": ["WT","SO","BC","GDELT"],
    "w/o DISK-RAM-GPU Pipeline": [1313.52,12699.78,12556.42,48000],
    "DOLPHIN": [225.32,2147.01,2048.13,7013.94],
    
}
io_time_df = pd.DataFrame(io_time_data_dict)

# 
methods = ["w/o DISK-RAM-GPU Pipeline", "DOLPHIN"]
...
ax_left.set_ylabel("Runtime(s)", fontweight='bold', fontsize=26)


#ax_left.set_xlabel("Datasets", fontweight='bold', fontsize=24)
