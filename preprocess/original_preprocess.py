...
parser.add_argument('--txt', type=str, help='txt file path', default = "/DOLPHIN/preprocess/test.txt")
...
print('to DataFrame...')
df = pd.read_csv('/DOLPHIN/data/{}/edges.csv'.format(args.data)) 
...
print('save csv...')
df.to_csv('/DOLPHIN/data/{}/edges.csv'.format(args.data))
...
print('saving...')
np.savez('/DOLPHIN/data/{}/ext_full.npz'.format(args.data), indptr=ext_full_indptr, indices=ext_full_indices, ts=ext_full_ts, eid=ext_full_eid)